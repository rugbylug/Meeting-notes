During the social, we discussed many candidates for a Mycroft skill project but felt that the most useful would be:

1. Check-list / Todo list

2. Voice interface to MythTV

The preference was for the check-list skill as it is seems more achievable in a short time.
